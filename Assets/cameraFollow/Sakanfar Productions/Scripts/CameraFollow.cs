...
namespace FollowCamera // Or any other appropriate namespace
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        [SerializeField] private FollowCamera.PlayerController playerController;[Header("Zoom/Aim Settings")]
        ...
        void Start()
        {
            ...
            if (playerBody == null)
            {
                ...
                else
                {
                    ...
                    FollowCamera.PlayerController playerControllerComponent = FindFirstObjectByType<FollowCamera.PlayerController>();
            ...
            {
                if (playerBody != null)
                    playerController = playerBody.GetComponent<FollowCamera.PlayerController>();
                else
                    playerController = FindFirstObjectByType<FollowCamera.PlayerController>();
            }
